...
- Transactional idempotent snapshot persistence contract and deterministic fake-DB coverage
- Initial Supabase persistence migration applied and remotely inspected
- Bounded remote persistence smoke with Decimal preservation, idempotent replay, immutable-conflict rejection, and cleanup
