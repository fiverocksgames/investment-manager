...
| REQ-PROVIDER-001 | Common provider adapter contract | 2 | In Validation | `DataProvider`, `FredProvider`, `YahooProvider`, Yahoo live smoke | Provider fixtures and smoke validation; Python run #16 | #18, #20, #29, #31 |
| REQ-PROVIDER-002 | Explicit validation and failure classification | 2 | In Validation | Canonical failures plus FRED and Yahoo failure classes | Deterministic failure and smoke tests; Python run #16 | #18, #20, #29, #31 |
...
| REQ-MKT-001 | Collect and normalize market, macro, and FX data | 2 | In Validation | FRED macro data plus Yahoo daily market and FX adapters | FRED fixtures, Yahoo fixtures, Python run #16; live smoke pending | #20, #29, #31 |
| REQ-MKT-002 | Expose source, retrieval time, and freshness | 2 | In Validation | FRED revision metadata and Yahoo metadata plus bounded smoke evidence | Metadata and smoke tests; Python run #16; live smoke pending | #20, #29, #31 |
