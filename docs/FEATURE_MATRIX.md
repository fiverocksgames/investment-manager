...
| REQ-DATA-002 | Preserve source, revision, quality, cutoff, and freshness metadata | 2 | In Validation | Canonical metadata, FX provenance, deterministic snapshot checksum/content identity | Snapshot provenance and ordering tests; final CI pending | #16, #18, #43, #45 |
...
| REQ-PROVIDER-002 | Explicit validation and failure classification | 2 | In Validation | Canonical failures, retry, transport diagnostics, typed FX and snapshot publication failures | FX/snapshot deterministic failure tests; final CI pending | #18, #20, #29, #33, #35, #37, #39, #43, #45 |
...
| REQ-MKT-002 | Expose source, retrieval time, freshness, FX direction, and reproducible source-set identity | 2 | In Validation | Provider metadata, `FxPair`, snapshot checksum/UUID/cutoff | FX provenance plus snapshot provenance/identity tests; final CI pending | #20, #29, #31, #37, #39, #43, #45 |
