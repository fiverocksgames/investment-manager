...
| REQ-PROVIDER-002 | Explicit validation and failure classification | 2 | In Validation | Canonical failures, retry, transport diagnostics, typed FX/snapshot/persistence/cache/ingestion validation | Deterministic failure/conflict/cache/ingestion tests | #18, #20, #29, #33, #35, #37, #39, #43, #45, #47, #58, #62 |
| REQ-OPS-002 | Idempotent ingestion and immutable snapshots | 2 | In Validation | `SourceSnapshotPublisher`, `SnapshotRepository`, Supabase persistence migrations, `IngestionOrchestrator` | Snapshot identity/cutoff tests, atomic replay/conflict/rollback tests, remote schema validation, orchestration tests | #16, #45, #47, #51, #55, #62 |
...
| REQ-MKT-002 | Expose source, retrieval time, freshness, FX direction, reproducible source-set identity, persisted provenance, cache reuse, and ingestion status | 2 | In Validation | Provider metadata, `FxPair`, snapshot checksum/UUID/cutoff, PostgreSQL persistence, cache metadata, `IngestionExecution` | FX/snapshot/persistence/cache/ingestion provenance tests | #20, #29, #31, #37, #39, #43, #45, #47, #58, #62 |
| REQ-OPS-001 | Run scheduled data and analysis jobs | 2 | In Validation | `IngestionJob`, `IngestionOrchestrator`, `docs/SCHEDULED_INGESTION.md`; production scheduler deferred | Python #96, Documentation #156; production scheduling still pending | #62 |
