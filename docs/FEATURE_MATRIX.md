...
| REQ-PROVIDER-001 | Common provider adapter contract | 2 | In Validation | `DataProvider`, `FredProvider`, `YahooProvider`, `EcosProvider` | Provider fixtures, live smoke validation; ECOS CI pending | #18, #20, #29, #31, #37 |
| REQ-PROVIDER-002 | Explicit validation and failure classification | 2 | In Validation | Canonical failures, FRED/Yahoo/ECOS adapters, bounded retry, Yahoo transport headers | Deterministic failure, retry, transport, and ECOS fixtures; ECOS CI pending | #18, #20, #29, #31, #33, #35, #37 |
...
| REQ-MKT-001 | Collect and normalize market, macro, and FX data | 2 | In Validation | FRED macro, Yahoo daily market/FX, ECOS economic-series adapter | Yahoo live run `31169043266` succeeded; ECOS fixture/CI pending | #20, #29, #31, #33, #35, #37 |
| REQ-MKT-002 | Expose source, retrieval time, and freshness | 2 | In Validation | FRED revision metadata, Yahoo metadata, ECOS statistic/item/cycle metadata | Metadata fixtures; Yahoo live evidence; ECOS CI pending | #20, #29, #31, #37 |
