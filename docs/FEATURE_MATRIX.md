...
| REQ-PROVIDER-002 | Explicit validation and failure classification | 2 | In Validation | Canonical failures, provider adapters, bounded retry, Yahoo transport headers | Deterministic failure, smoke, retry, and transport tests; CI pending for Issue #34 | #18, #20, #29, #31, #33; Issue #34 |
...
| REQ-MKT-001 | Collect and normalize market, macro, and FX data | 2 | In Validation | FRED macro plus Yahoo daily market/FX adapter and hardened transport | FRED/Yahoo fixtures; live runs `31141445027`, `31150601290`; Issue #34 CI pending | #20, #29, #31, #33; Issue #34 |
